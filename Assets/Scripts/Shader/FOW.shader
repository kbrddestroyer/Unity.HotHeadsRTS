Shader "Painted Render Texture Shader"
{
    Properties
    {
        ...
        SubShader
        {
           Tags { "Surface" = "Transparent" "Queue" = "Transparent" "RenderType" = "Transparent" "LightMode" = "ForwardBase" }
           ...
           void surf(Input IN, inout SurfaceOutput o)
           {
               ...
               o.Albedo = _Color.rgb * blurred.r * blurred.g * blurred.b;
               o.Alpha = _Color.a - blurred.g * blurred.r * blurred.g;
           }
